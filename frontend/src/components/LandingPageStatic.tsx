...
export function LandingPageStatic({ primaryHref, primaryLabel, siteUrl }: LandingPageStaticProps) {
  return (
    <>
        ...
        <header className="sticky top-0 z-20 border-b border-white/10 bg-bg/80 backdrop-blur">
          <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6">
            <div className="flex items-center justify-between gap-4">
              ...
              >
                <span className="sm:hidden">{primaryLabel === "Open Workspace" ? "Open" : "Start"}</span>
        ...
        <main>
          ...
          <section className="mx-auto max-w-6xl px-4 pb-20 sm:px-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {FEATURED_TRANSFORMS.map((transform) => (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(createLandingStructuredData(siteUrl)),
        }}
      />
    </>
  );
